...
namespace Client.Logic.Windows.Editors.MapEditor
{
    ...
    class winProperties : Window
    {
        ...
        public winProperties()
            ...
            btnGeneral.Font = Logic.Graphics.FontManager.LoadFont("PMDCP", 18);
            ...
            btnNPC.Font = Logic.Graphics.FontManager.LoadFont("PMDCP", 18);
            ...
            btnScroll.Font = Logic.Graphics.FontManager.LoadFont("PMDCP", 18);
            ...
            lblMapName.Font = Logic.Graphics.FontManager.LoadFont("PMDCP", 18);
            ...
            lblMapSwitchover.Font = Logic.Graphics.FontManager.LoadFont("PMDCP", 22);
            ...
            lblNorth.Font = Logic.Graphics.FontManager.LoadFont("PMDCP", 18);
            ...
            lblSouth.Font = Logic.Graphics.FontManager.LoadFont("PMDCP", 18);
            ...
            lblEast.Font = Logic.Graphics.FontManager.LoadFont("PMDCP", 18);
            ...
            lblWest.Font = Logic.Graphics.FontManager.LoadFont("PMDCP", 18);
            ...
            lblGlobal.Font = Logic.Graphics.FontManager.LoadFont("PMDCP", 22);
            ...
            lblMapMorality.Font = Logic.Graphics.FontManager.LoadFont("PMDCP", 18);
            ...
            //cmbMapMorality.Font = Graphics.FontManager.LoadFont("PMDCP", 18);
            ...
            cmbMapMorality.Items.Add(new ListBoxTextItem(Logic.Graphics.FontManager.LoadFont("PMDCP", 18), "None"));
            cmbMapMorality.Items.Add(new ListBoxTextItem(Logic.Graphics.FontManager.LoadFont("PMDCP", 18), "Safe Zone"));
            cmbMapMorality.Items.Add(new ListBoxTextItem(Logic.Graphics.FontManager.LoadFont("PMDCP", 18), "No Death Penalty"));
            cmbMapMorality.Items.Add(new ListBoxTextItem(Logic.Graphics.FontManager.LoadFont("PMDCP", 18), "House"));
            cmbMapMorality.SelectItem((int)properties.Moral);

            lblMapWeather = new Label("lblMapWeather");
            lblMapWeather.Font = Logic.Graphics.FontManager.LoadFont("PMDCP", 18);
            ...
            cmbMapWeather.Items.Add(new ListBoxTextItem(Logic.Graphics.FontManager.LoadFont("PMDCP", 18), "Ambiguous"));
            cmbMapWeather.Items.Add(new ListBoxTextItem(Logic.Graphics.FontManager.LoadFont("PMDCP", 18), "None"));
            cmbMapWeather.Items.Add(new ListBoxTextItem(Logic.Graphics.FontManager.LoadFont("PMDCP", 18), "Raining"));
            cmbMapWeather.Items.Add(new ListBoxTextItem(Logic.Graphics.FontManager.LoadFont("PMDCP", 18), "Snowing"));
            cmbMapWeather.Items.Add(new ListBoxTextItem(Logic.Graphics.FontManager.LoadFont("PMDCP", 18), "Thunder"));
            cmbMapWeather.Items.Add(new ListBoxTextItem(Logic.Graphics.FontManager.LoadFont("PMDCP", 18), "Hail"));
            cmbMapWeather.Items.Add(new ListBoxTextItem(Logic.Graphics.FontManager.LoadFont("PMDCP", 18), "Diamond Dust"));
            cmbMapWeather.Items.Add(new ListBoxTextItem(Logic.Graphics.FontManager.LoadFont("PMDCP", 18), "Cloudy"));
            cmbMapWeather.Items.Add(new ListBoxTextItem(Logic.Graphics.FontManager.LoadFont("PMDCP", 18), "Fog"));
            cmbMapWeather.Items.Add(new ListBoxTextItem(Logic.Graphics.FontManager.LoadFont("PMDCP", 18), "Sunny"));
            cmbMapWeather.Items.Add(new ListBoxTextItem(Logic.Graphics.FontManager.LoadFont("PMDCP", 18), "Sandstorm"));
            cmbMapWeather.Items.Add(new ListBoxTextItem(Logic.Graphics.FontManager.LoadFont("PMDCP", 18), "Snowstorm"));
            cmbMapWeather.Items.Add(new ListBoxTextItem(Logic.Graphics.FontManager.LoadFont("PMDCP", 18), "Ashfall"));
            cmbMapWeather.SelectItem((int)properties.Weather);

            lblMapDarkness = new Label("lblMapDarkness");
            lblMapDarkness.Font = Logic.Graphics.FontManager.LoadFont("PMDCP", 18);
            ...
            lblMapTimeLimit.Font = Logic.Graphics.FontManager.LoadFont("PMDCP", 18);
            ...
            //lblNpcSelector.Font = Logic.Graphics.FontManager.LoadFont("PMDCP", 18);
            ...
            //    cmbNpcSelector.Items.Add(new ListBoxTextItem(Logic.Graphics.FontManager.LoadFont("PMDCP", 18), "NPC " + (i + 1)));
            //}
            //cmbNpcSelector.ItemSelected += new EventHandler(cmbNpcSelector_ItemSelected);

            //lblNpcNum = new Label("lblNpcNum");
            //lblNpcNum.Font = Logic.Graphics.FontManager.LoadFont("PMDCP", 18);
            ...
            //lblNpcNumInfo.Font = Logic.Graphics.FontManager.LoadFont("PMDCP", 18);
            ...
            //lblNpcSpawnX.Font = Logic.Graphics.FontManager.LoadFont("PMDCP", 18);
            ...
            //lblNpcSpawnY.Font = Logic.Graphics.FontManager.LoadFont("PMDCP", 18);
            ...
            //lblNpcLevel.Font = Logic.Graphics.FontManager.LoadFont("PMDCP", 18);
            ...
            lblMaxX.Font = Logic.Graphics.FontManager.LoadFont("PMDCP", 18);
            lblMaxX.AutoSize = true;
            lblMaxX.Location = new Point(54, 0);
            lblMaxX.Text = "Max X:";

            lblMaxY = new Label("lblMaxY");
            lblMaxY.Font = Logic.Graphics.FontManager.LoadFont("PMDCP", 18);
