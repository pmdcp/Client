...
namespace Client.Logic.Windows
{
    partial class winGame
    {
        ...
        public void InitMapEditorWidgets() {
            ...
            btnTitle.Font = Graphics.FontManager.LoadFont("PMDCP", 18);
            btnTitle.Visible = false;
            Skins.SkinManager.LoadButtonGui(btnTitle);

            lbl1 = new Label("lbl1");
            lbl1.AutoSize = true;
            lbl1.Font = Graphics.FontManager.LoadFont("PMDCP", 18);
            lbl1.Location = new Point(0, 35);
            lbl1.Visible = false;

            lbl2 = new Label("lbl2");
            lbl2.AutoSize = true;
            lbl2.Font = Graphics.FontManager.LoadFont("PMDCP", 18);
            lbl2.Visible = false;

            lbl3 = new Label("lbl3");
            lbl3.AutoSize = true;
            lbl3.Font = Graphics.FontManager.LoadFont("PMDCP", 18);
            lbl3.Visible = false;

            lbl4 = new Label("lbl4");
            lbl4.AutoSize = true;
            lbl4.Font = Graphics.FontManager.LoadFont("PMDCP", 18);
            lbl4.Visible = false;

            lblMode = new Label("lblMode");
            lblMode.AutoSize = true;
            lblMode.Font = Graphics.FontManager.LoadFont("PMDCP", 18);
            ...
            nudStoryLevel.Font = Graphics.FontManager.LoadFont("PMDCP", 18);
            ...
            btnBack.Font = Graphics.FontManager.LoadFont("PMDCP", 18);
            btnBack.Text = "Back";
            ...
            nudDungeonTileValue.Font = Graphics.FontManager.LoadFont("PMDCP", 18);
            ...
            btnMapping.Font = Graphics.FontManager.LoadFont("PMDCP.ttf", 24);
            ...
            btnLayers.Font = Graphics.FontManager.LoadFont("PMDCP.ttf", 24);
            ...
            btnTileset.Font = Graphics.FontManager.LoadFont("PMDCP.ttf", 24);
            ...
            btnSettings.Font = Graphics.FontManager.LoadFont("PMDCP.ttf", 24);
