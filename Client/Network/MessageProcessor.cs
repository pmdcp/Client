...
namespace Client.Logic.Network
{
    ...
    class MessageProcessor
    {
        ...
        public static SdlDotNet.Widgets.CharRenderOptions[] ParseText(SdlDotNet.Widgets.CharRenderOptions[] renderOptions, ref string text) {
            ...
            //int index = text.IndexOf("[7a1e7547e613ec0651]");
            //while (index > -1) {
            //    int colorStartIndex = text.IndexOf('[', index + 20);
            ...
            //        text = text.Remove(index, 20);
            //        newRenderOptions.RemoveRange(index, 20);

            //        text = text.Remove(colorStartIndex - 20, colorValue.Length + 2);
            //        newRenderOptions.RemoveRange(colorStartIndex - 20, colorValue.Length + 2);

            //        int endIndex = text.IndexOf("[/7a1e7547e613ec0651]");
            //        if (endIndex > -1) {
            //            text = text.Remove(endIndex, 21);
            //            newRenderOptions.RemoveRange(endIndex, 21);
            //            for (int i = index; i < endIndex; i++) {
            ...
            //    }
            //    index = text.IndexOf("[7a1e7547e613ec0651]", StringComparison.Ordinal);
            //}
