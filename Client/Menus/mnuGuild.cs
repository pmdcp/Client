...
namespace Client.Logic.Menus
{
    class mnuGuild : Widgets.BorderedPanel, Core.IMenu
    {
        ...
        public mnuGuild(string name)
            ...
            lblName.Font = FontManager.LoadFont("PMDCP", 32);
            lblName.Text = "Name";
            ...
            lblMakeTrainee.Font = FontManager.LoadFont("PMDCP", 32);
            ...
            lblMakeMember.Font = FontManager.LoadFont("PMDCP", 32);
            ...
            lblDisown.Font = FontManager.LoadFont("PMDCP", 32);
