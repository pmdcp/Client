...
namespace Client.Logic.Menus
{
    ...
    class mnuJobDescription : Logic.Widgets.BorderedPanel, Core.IMenu
    {
        ...
        public mnuJobDescription(string name, Job job, bool missionBoardView)
            ...
            lblDescription.Font = FontManager.LoadFont("PMDCP", 48);
            ...
            lblNullTitle.Font = FontManager.LoadFont("PMDCP", 32);
            ...
            lblTitle.Font = FontManager.LoadFont("PMDCP", 16);
            ...
            lblCreatorName.Font = FontManager.LoadFont("PMDCP", 16);
            ...
            lblSummary.Font = FontManager.LoadFont("PMDCP", 16);
            ...
            lblObjective.Font = FontManager.LoadFont("PMDCP", 16);
            ...
            lblPressEnter.Font = FontManager.LoadFont("PMDCP", 32);
