...
namespace Client.Logic.Menus
{
    class mnuTrade : Widgets.BorderedPanel, Core.IMenu
    {
            ...
            : base(name)
        {
            ...
            lblAmount.Font = FontManager.LoadFont("PMDCP", 18);
            ...
            lblClient.Font = FontManager.LoadFont("PMDCP", 18);
            ...
            lblClientItem.Font = FontManager.LoadFont("PMDCP", 18);
            ...
            lblMyItem.Font = FontManager.LoadFont("PMDCP", 18);
            ...
            btnConfirm.Font = FontManager.LoadFont("PMDCP", 18);
            ...
            btnItemSet.Font = FontManager.LoadFont("PMDCP", 18);
            ...
            btnCancel.Font = FontManager.LoadFont("PMDCP", 18);
