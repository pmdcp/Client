...
namespace Client.Logic.Menus
{
    class mnuAdventureLog : Widgets.BorderedPanel, Core.IMenu
    {
            ...
            : base(name)
        {
            ...
            lblAdventureLog.Font = FontManager.LoadFont("PMDCP", 48);
            ...
            lblPage.Font = FontManager.LoadFont("PMDCP", 16);
            ...
            lblGeneral.Font = FontManager.LoadFont("PMDCP", 32);
            ...
            lblPlayerName.Font = FontManager.LoadFont("PMDCP", 16);
            ...
            lblRank.Font = FontManager.LoadFont("PMDCP", 16);
            ...
            lblPlayTime.Font = FontManager.LoadFont("PMDCP", 16);
            ...
            lblDungeonsCompleted.Font = FontManager.LoadFont("PMDCP", 16);
            ...
            lblMissionsCompleted.Font = FontManager.LoadFont("PMDCP", 16);
            ...
            //lblRescuesCompleted.Font = FontManager.LoadFont("PMDCP", 16);
            ...
            lblDungeons.Font = FontManager.LoadFont("PMDCP", 32);
            ...
            lblEntered.Font = FontManager.LoadFont("PMDCP", 16);
            ...
            lblCompleted.Font = FontManager.LoadFont("PMDCP", 16);
            ...
            lblPokedex.Font = FontManager.LoadFont("PMDCP", 32);
            ...
            lblDefeated.Font = FontManager.LoadFont("PMDCP", 16);
            ...
            lblJoined.Font = FontManager.LoadFont("PMDCP", 16);
