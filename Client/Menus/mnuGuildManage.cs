...
namespace Client.Logic.Menus {
    class mnuGuildManage : Widgets.BorderedPanel, Core.IMenu {
        ...
        public mnuGuildManage(string name, string[] parse)
            ...
            lblYourName.Font = FontManager.LoadFont("PMDCP", 16);
            ...
            lblPromotePrice.Font = FontManager.LoadFont("PMDCP", 16);
            ...
            btnPromote.Font = Client.Logic.Graphics.FontManager.LoadFont("PMDCP", 16);
            ...
            btnDemote.Font = Client.Logic.Graphics.FontManager.LoadFont("PMDCP", 16);
            ...
            btnOKAdd.Font = Client.Logic.Graphics.FontManager.LoadFont("PMDCP", 16);
            btnOKAdd.Text = "Add";
